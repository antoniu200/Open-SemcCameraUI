...
class T4_T6_Tables
{
    ...
    public static class Entry
    {
        ...
        public Entry(final String bitString, final int i) {
            this.bitString = bitString;
            this.value = i;
        }
        
        public void writeBits(final BitArrayOutputStream bitArrayOutputStream) {
