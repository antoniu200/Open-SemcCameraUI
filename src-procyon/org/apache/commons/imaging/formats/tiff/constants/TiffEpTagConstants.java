...
public final class TiffEpTagConstants
{
    ...
    public static final TagInfoByte EXIF_TAG_CFAPATTERN_2;
    public static final TagInfoShort EXIF_TAG_CFAREPEAT_PATTERN_DIM;
    public static final TagInfoRational EXIF_TAG_EXPOSURE_INDEX;
    public static final TagInfoRational EXIF_TAG_FLASH_ENERGY;
    ...
    public static final TagInfoUndefined EXIF_TAG_INTER_COLOR_PROFILE;
    public static final TagInfoUndefined EXIF_TAG_NOISE_1;
    ...
    public static final TagInfoByte EXIF_TAG_TIFF_EPSTANDARD_ID_1;
    public static final TagInfoSShort EXIF_TAG_TIME_ZONE_OFFSET;
    ...
    static {
        EXIF_TAG_CFAREPEAT_PATTERN_DIM = new TagInfoShort("CFARepeatPatternDim", 33421, 2, TiffDirectoryType.EXIF_DIRECTORY_UNKNOWN);
        EXIF_TAG_CFAPATTERN_2 = new TagInfoByte("CFAPattern2", 33422, -1, TiffDirectoryType.EXIF_DIRECTORY_UNKNOWN);
        EXIF_TAG_BATTERY_LEVEL = new TagInfoAsciiOrRational("BatteryLevel", 33423, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
        EXIF_TAG_INTER_COLOR_PROFILE = new TagInfoUndefined("InterColorProfile", 34675, -1, TiffDirectoryType.EXIF_DIRECTORY_UNKNOWN);
        EXIF_TAG_INTERLACE = new TagInfoShort("Interlace", 34857, 1, TiffDirectoryType.EXIF_DIRECTORY_UNKNOWN);
        EXIF_TAG_TIME_ZONE_OFFSET = new TagInfoSShort("TimeZoneOffset", 34858, -1, TiffDirectoryType.EXIF_DIRECTORY_EXIF_IFD);
        EXIF_TAG_SELF_TIMER_MODE = new TagInfoShort("SelfTimerMode", 34859, 1, TiffDirectoryType.EXIF_DIRECTORY_EXIF_IFD);
        EXIF_TAG_FLASH_ENERGY = new TagInfoRational("FlashEnergy", 37387, -1, TiffDirectoryType.EXIF_DIRECTORY_UNKNOWN);
        EXIF_TAG_SPATIAL_FREQUENCY_RESPONSE_1 = new TagInfoUndefined("SpatialFrequencyResponse", 37388, -1, TiffDirectoryType.EXIF_DIRECTORY_UNKNOWN);
        EXIF_TAG_NOISE_1 = new TagInfoUndefined("Noise", 37389, -1, TiffDirectoryType.EXIF_DIRECTORY_UNKNOWN);
        EXIF_TAG_FOCAL_PLANE_XRESOLUTION = new TagInfoRational("FocalPlaneXResolution", 37390, 1, TiffDirectoryType.EXIF_DIRECTORY_UNKNOWN);
        EXIF_TAG_FOCAL_PLANE_YRESOLUTION = new TagInfoRational("FocalPlaneYResolution", 37391, 1, TiffDirectoryType.EXIF_DIRECTORY_UNKNOWN);
        EXIF_TAG_FOCAL_PLANE_RESOLUTION_UNIT = new TagInfoShort("FocalPlaneResolutionUnit", 37392, 1, TiffDirectoryType.EXIF_DIRECTORY_UNKNOWN);
        EXIF_TAG_IMAGE_NUMBER_EXIF_IFD = new TagInfoLong("ImageNumber", 37393, 1, TiffDirectoryType.EXIF_DIRECTORY_EXIF_IFD);
        ...
        EXIF_TAG_EXPOSURE_INDEX = new TagInfoRational("ExposureIndex", 37397, -1, TiffDirectoryType.EXIF_DIRECTORY_UNKNOWN);
        EXIF_TAG_TIFF_EPSTANDARD_ID_1 = new TagInfoByte("TIFF/EPStandardID", 37398, 4, TiffDirectoryType.EXIF_DIRECTORY_UNKNOWN);
        EXIF_TAG_SENSING_METHOD = new TagInfoShort("SensingMethod", 37399, 1, TiffDirectoryType.EXIF_DIRECTORY_UNKNOWN);
