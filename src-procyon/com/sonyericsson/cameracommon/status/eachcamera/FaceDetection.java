...
public class FaceDetection extends EnumValue<Value> implements EachCameraStatusValue
{
    ...
    public FaceDetection(final Value value) {
        super(value);
    }
    ...
    public int minRequiredVersion() {
        return FaceDetection.REQUIRED_PROVIDER_VERSION;
    }
