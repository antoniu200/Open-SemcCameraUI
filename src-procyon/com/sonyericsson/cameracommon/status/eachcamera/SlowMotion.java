...
public class SlowMotion extends EnumValue<Value> implements EachCameraStatusValue
{
    ...
    public SlowMotion(final Value value) {
        super(value);
    }
    ...
    public int minRequiredVersion() {
        return SlowMotion.REQUIRED_PROVIDER_VERSION;
    }
