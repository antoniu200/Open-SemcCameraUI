...
public class Constants
{
    ...
    static {
        ...
        SHARE_MPO_EXCLUDES = Collections.unmodifiableList((List<? extends String>)Arrays.asList("com.google.android.apps.uploader"));
    }
    
    public static final List<String> getShareMpoExcludes() {
        return new ArrayList<String>(Constants.SHARE_MPO_EXCLUDES);
    }
    
    public static final List<String> getSharePhotoVideoExcludes() {
        return new ArrayList<String>(Constants.SHARE_PHOTO_VIDEO_EXCLUDES);
    }
