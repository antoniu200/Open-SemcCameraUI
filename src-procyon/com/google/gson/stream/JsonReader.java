...
public class JsonReader implements Closeable
{
        ...
        Label_0015:
            while (true) {
                ...
                while (true) {
                    ...
                    while (true) {
                        final int pos = lineStart;
                        if (pos >= n) {
                            sb.append(buffer, offset, pos - offset);
                            this.pos = pos;
                            continue Label_0015;
                        }
                        lineStart = pos + 1;
                        ...
                        if (c2 == c) {
                            sb.append(buffer, offset, (this.pos = lineStart) - offset - 1);
                            return sb.toString();
                        }
                        if (c2 == '\\') {
                            sb.append(buffer, offset, (this.pos = lineStart) - offset - 1);
                ...
                Label_0203: {
                    while (true) {
                        if (this.pos + len < this.limit) {
                            switch (this.buffer[this.pos + len]) {
                                default: {
                                    ++len;
                                    continue;
                                }
                    ...
                    sb2.append(this.buffer, this.pos, len);
                    this.pos += len;
                    sb = sb2;
                    continue;
                }
    ...
    Label_0317:
                                ...
                                Label_0296: {
                                    if (n2 != 1 && n2 != 0) {
                                        if (n2 == 2) {
                                            ...
                                            n5 = 10L * peekedLong - (c - '0');
                                            final long n6 = lcmp(peekedLong, -922337203685477580L);
                                            n7 = (((n6 > 0 || (n6 == 0 && n5 < peekedLong)) ? 1 : 0) & n);
                                            n8 = n2;
                                        }
                                        else {
                                            if (n2 == 3) {
        ...
        if (n2 == 2 && n && (peekedLong != Long.MIN_VALUE || n3 != 0)) {
            if (n3 == 0) {
