...
public class zzh implements Parcelable$Creator<SignInConfiguration>
{
    ...
    public SignInConfiguration zzS(final Parcel parcel) {
        ...
        Object o = o2 = zzp2;
        Object zzp3;
        SafeParcelable safeParcelable = (SafeParcelable)(zzp3 = o2);
        int zzg = 0;
        while (parcel.dataPosition() < zzap) {
            ...
            switch (zza.zzbM(zzao)) {
                ...
                case 6: {
                    safeParcelable = zza.zza(parcel, zzao, FacebookSignInConfig.CREATOR);
                    continue;
                }
                case 5: {
                    o2 = zza.zza(parcel, zzao, GoogleSignInConfig.CREATOR);
                    continue;
                }
                case 4: {
                    o = zza.zza(parcel, zzao, EmailSignInConfig.CREATOR);
                    continue;
                }
                case 3: {
        ...
        return new SignInConfiguration(zzg, zzp, (String)zzp2, (EmailSignInConfig)o, (GoogleSignInConfig)o2, (FacebookSignInConfig)safeParcelable, (String)zzp3);
    }
