...
public class Credential implements SafeParcelable
{
    ...
    Credential(final int mVersionCode, final String s, final String mName, final Uri zzSh, final List<IdToken> list, final String zzSj, final String zzSk, final String zzSl, final String zzSm) {
        ...
        List<Object> zzSi;
        if (list == null) {
            zzSi = (List<Object>)Collections.emptyList();
        }
        else {
            zzSi = (List<Object>)Collections.unmodifiableList((List<? extends IdToken>)list);
        }
        this.zzSi = (List<IdToken>)zzSi;
        this.zzSj = zzSj;
        this.zzSk = zzSk;
        this.zzSl = zzSl;
        this.zzSm = zzSm;
    ...
    public static class Builder
    {
        ...
        public Builder(final String zzwN) {
            this.zzwN = zzwN;
        }
        ...
        public Builder setAccountType(final String zzSk) {
            final String scheme = Uri.parse(zzSk).getScheme();
        ...
        public Builder setPassword(final String zzSj) {
            this.zzSj = zzSj;
            return this;
        }
        
        public Builder setProfilePictureUri(final Uri zzSh) {
            this.zzSh = zzSh;
            return this;
        }
    }
