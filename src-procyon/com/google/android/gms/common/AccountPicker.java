...
public final class AccountPicker
{
    ...
    public static Intent zza(final Account account, final ArrayList<Account> list, final String[] array, final boolean b, final String s, final String s2, final String[] array2, final Bundle bundle, final boolean b2, final int n, final int n2) {
        return zza(account, list, array, b, s, s2, array2, bundle, b2, n, n2, false);
    }
    
    public static Intent zza(final Account account, final ArrayList<Account> list, final String[] array, final boolean b, final String s, final String s2, final String[] array2, final Bundle bundle, final boolean b2, final int n, final int n2, final boolean b3) {
