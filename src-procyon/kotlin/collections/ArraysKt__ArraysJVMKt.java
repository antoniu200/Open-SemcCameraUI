...
class ArraysKt__ArraysJVMKt
{
    ...
    @NotNull
    public static final <T> T[] arrayOfNulls(@NotNull final T[] array, final int length) {
        Intrinsics.checkParameterIsNotNull(array, "reference");
    ...
    private static final <T> T[] orEmpty(@Nullable T[] array) {
        if (array == null) {
    ...
    @InlineOnly
    private static final String toString(@NotNull final byte[] bytes, final Charset charset) {
        return new String(bytes, charset);
    }
    
    private static final <T> T[] toTypedArray(@NotNull final Collection<? extends T> collection) {
        if (collection == null) {
