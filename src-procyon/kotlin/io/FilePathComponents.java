...
public final class FilePathComponents
{
    ...
    @NotNull
    public final FilePathComponents copy(@NotNull final File file, @NotNull final List<? extends File> list) {
    ...
    @NotNull
    public final File subPath(final int n, final int n2) {
        if (n >= 0 && n <= n2 && n2 <= this.getSize()) {
            final Iterable iterable = this.segments.subList(n, n2);
            final String separator = File.separator;
            Intrinsics.checkExpressionValueIsNotNull(separator, "File.separator");
            return new File(CollectionsKt___CollectionsKt.joinToString$default(iterable, (CharSequence)separator, (CharSequence)null, (CharSequence)null, 0, (CharSequence)null, (Function1)null, 62, (Object)null));
        }
