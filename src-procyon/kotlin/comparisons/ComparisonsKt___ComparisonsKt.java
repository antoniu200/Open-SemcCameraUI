...
class ComparisonsKt___ComparisonsKt extends ComparisonsKt___ComparisonsJvmKt
{
    ...
    @SinceKotlin(version = "1.1")
    public static final <T> T maxOf(T t, final T t2, @NotNull final Comparator<? super T> comparator) {
        Intrinsics.checkParameterIsNotNull(comparator, "comparator");
    ...
    @SinceKotlin(version = "1.1")
    public static final <T> T minOf(T t, final T t2, @NotNull final Comparator<? super T> comparator) {
        Intrinsics.checkParameterIsNotNull(comparator, "comparator");
        if (comparator.compare(t, t2) > 0) {
            t = t2;
        }
