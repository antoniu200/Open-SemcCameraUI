...
public enum CharCategory
{
    ...
    protected CharCategory(final int value, final String code) {
    ...
    public final boolean contains(final char ch) {
        return Character.getType(ch) == this.value;
    }
    ...
    public static final class Companion
    {
        ...
        private final Map<Integer, CharCategory> getCategoryMap() {
            ...
            return (Map<Integer, CharCategory>)access$getCategoryMap$cp.getValue();
        }
        
        @NotNull
        public final CharCategory valueOf(final int n) {
            final CharCategory charCategory = this.getCategoryMap().get(n);
