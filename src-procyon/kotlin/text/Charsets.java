...
public final class Charsets
{
    ...
    public final Charset UTF32() {
        Charset utf_32 = Charsets.utf_32;
        if (utf_32 == null) {
            final Charsets charsets = this;
            utf_32 = Charset.forName("UTF-32");
            Intrinsics.checkExpressionValueIsNotNull(utf_32, "Charset.forName(\"UTF-32\")");
            Charsets.utf_32 = utf_32;
        }
        return utf_32;
    }
    ...
    public final Charset UTF32_BE() {
        Charset utf_32be = Charsets.utf_32be;
        if (utf_32be == null) {
            final Charsets charsets = this;
            utf_32be = Charset.forName("UTF-32BE");
            Intrinsics.checkExpressionValueIsNotNull(utf_32be, "Charset.forName(\"UTF-32BE\")");
            Charsets.utf_32be = utf_32be;
        }
        return utf_32be;
    }
    ...
    public final Charset UTF32_LE() {
        Charset utf_32le = Charsets.utf_32le;
        if (utf_32le == null) {
            final Charsets charsets = this;
            utf_32le = Charset.forName("UTF-32LE");
            Intrinsics.checkExpressionValueIsNotNull(utf_32le, "Charset.forName(\"UTF-32LE\")");
            Charsets.utf_32le = utf_32le;
        }
        return utf_32le;
    }
}
