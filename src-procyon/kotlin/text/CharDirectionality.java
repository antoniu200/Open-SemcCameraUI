...
public enum CharDirectionality
{
    ...
    protected CharDirectionality(final int value) {
        this.value = value;
    }
    ...
    public static final class Companion
    {
        ...
        private final Map<Integer, CharDirectionality> getDirectionalityMap() {
            ...
            return (Map<Integer, CharDirectionality>)access$getDirectionalityMap$cp.getValue();
        }
        
        @NotNull
        public final CharDirectionality valueOf(final int n) {
            final CharDirectionality charDirectionality = this.getDirectionalityMap().get(n);
