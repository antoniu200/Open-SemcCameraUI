...
public final class DropSequence<T> implements Sequence<T>, DropTakeSequence<T>
{
    ...
    public DropSequence(@NotNull final Sequence<? extends T> sequence, int count) {
    ...
    public Sequence<T> take(final int n) {
        return new SubSequence<T>((Sequence<? extends T>)this.sequence, this.count, this.count + n);
    }
}
