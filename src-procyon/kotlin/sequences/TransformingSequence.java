...
public final class TransformingSequence<T, R> implements Sequence<R>
{
    ...
    @NotNull
    public final <E> Sequence<E> flatten$kotlin_stdlib(@NotNull final Function1<? super R, ? extends Iterator<? extends E>> function1) {
        Intrinsics.checkParameterIsNotNull(function1, "iterator");
        return new FlatteningSequence<Object, Object, E>(this.sequence, this.transformer, function1);
    }
