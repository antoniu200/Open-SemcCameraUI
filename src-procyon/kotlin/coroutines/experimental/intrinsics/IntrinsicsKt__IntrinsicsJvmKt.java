...
class IntrinsicsKt__IntrinsicsJvmKt
{
    ...
    private static final <T> Continuation<Unit> buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt(final Continuation<? super T> continuation, final Function0<?> function0) {
        return CoroutineIntrinsics.interceptContinuationIfNeeded(continuation.getContext(), (Continuation<? super Unit>)new IntrinsicsKt__IntrinsicsJvmKt$buildContinuationByInvokeCall$continuation.IntrinsicsKt__IntrinsicsJvmKt$buildContinuationByInvokeCall$continuation$1((Continuation)continuation, (Function0)function0));
    }
    
    @SinceKotlin(version = "1.1")
    @NotNull
    public static final <T> Continuation<Unit> createCoroutineUnchecked(@NotNull final Function1<? super Continuation<? super T>, ?> function1, @NotNull final Continuation<? super T> continuation) {
        ...
        if (!(function1 instanceof CoroutineImpl)) {
            continuation2 = CoroutineIntrinsics.interceptContinuationIfNeeded(continuation.getContext(), (Continuation<? super Object>)new IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnchecked$$inlined$buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt.IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnchecked$$inlined$buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt$1((Continuation)continuation, (Function1)function1, (Continuation)continuation));
        }
        else {
            final Continuation<Unit> create = ((CoroutineImpl)function1).create(continuation);
            if (create == null) {
                throw new TypeCastException("null cannot be cast to non-null type kotlin.coroutines.experimental.jvm.internal.CoroutineImpl");
            }
            continuation2 = ((CoroutineImpl)create).getFacade();
        }
        return (Continuation<Unit>)continuation2;
    }
    
    @SinceKotlin(version = "1.1")
    @NotNull
    public static final <R, T> Continuation<Unit> createCoroutineUnchecked(@NotNull final Function2<? super R, ? super Continuation<? super T>, ?> function2, final R r, @NotNull final Continuation<? super T> continuation) {
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final <T> Object startCoroutineUninterceptedOrReturn(@NotNull final Function1<? super Continuation<? super T>, ?> function1, final Continuation<? super T> continuation) {
        if (function1 == null) {
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final <R, T> Object startCoroutineUninterceptedOrReturn(@NotNull final Function2<? super R, ? super Continuation<? super T>, ?> function2, final R r, final Continuation<? super T> continuation) {
        if (function2 == null) {
