...
public final class LongRange extends LongProgression implements ClosedRange<Long>
{
    ...
    public boolean equals(@Nullable final Object o) {
        if (o instanceof LongRange) {
            if (!this.isEmpty() || !((LongRange)o).isEmpty()) {
                final long first = this.getFirst();
                final LongRange longRange = (LongRange)o;
                if (first != longRange.getFirst() || this.getLast() != longRange.getLast()) {
                    return false;
                }
            }
            return true;
    ...
    public int hashCode() {
        ...
        if (this.isEmpty()) {
            ...
            n = (int)(31 * (this.getFirst() ^ this.getFirst() >>> 32) + (this.getLast() ^ this.getLast() >>> 32));
        }
        return n;
    }
