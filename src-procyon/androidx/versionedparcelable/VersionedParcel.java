...
public abstract class VersionedParcel
{
    ...
    private <T> void writeCollection(final Collection<T> collection, int outputField) {
        ...
        if (outputField > 0) {
            ...
            switch (outputField) {
                ...
                case 1: {
                    final Iterator iterator5 = collection.iterator();
    ...
    public <T> List<T> readList(final List<T> list, final int n) {
        ...
        return this.readCollection(n, new ArrayList());
    }
    ...
    public <T> Set<T> readSet(final Set<T> set, final int n) {
        ...
        return this.readCollection(n, new ArraySet());
    }
    ...
    protected <T> void writeArray(final T[] array) {
        ...
        if (length > 0) {
            ...
            switch (type) {
                case 5: {
                    while (n < length) {
                        this.writeStrongBinder((IBinder)array[n]);
                        ++n;
                    }
                    break;
                }
                ...
                case 3: {
                    while (j < length) {
                        this.writeSerializable((Serializable)array[j]);
                        ++j;
                    }
                    break;
                }
                case 2: {
                    while (k < length) {
                        this.writeParcelable((Parcelable)array[k]);
                        ++k;
                    }
                    break;
                }
                case 1: {
                    while (l < length) {
                        this.writeVersionedParcelable((VersionedParcelable)array[l]);
                        ++l;
                    }
                    break;
                }
