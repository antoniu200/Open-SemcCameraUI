...
class FindAddress
{
    ...
    static String findAddress(final String input) {
        final Matcher matcher = FindAddress.sHouseNumberRe.matcher(input);
        int end = 0;
        while (matcher.find(end)) {
            if (checkHouseNumber(matcher.group(0))) {
                final int start = matcher.start();
                final int attemptMatch = attemptMatch(input, matcher);
                if (attemptMatch > 0) {
                    return input.substring(start, attemptMatch);
                }
                end = -attemptMatch;
            }
            else {
    ...
    @VisibleForTesting
    public static boolean isValidLocationName(final String input) {
        return FindAddress.sLocationNameRe.matcher(input).matches();
    }
    
    @VisibleForTesting
    public static boolean isValidZipCode(final String input) {
        return FindAddress.sZipCodeRe.matcher(input).matches();
    }
    ...
    private static boolean isValidZipCode(final String input, final MatchResult matchResult) {
        ...
        boolean b2 = b;
        if (FindAddress.sZipCodeRe.matcher(input).matches()) {
            b2 = b;
            if (FindAddress.sStateZipCodeRanges[n].matches(input)) {
                b2 = true;
            }
        }
        return b2;
    ...
    @VisibleForTesting
    public static MatchResult matchHouseNumber(final String input, final int start) {
        if (start > 0 && ":,\"'\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\n\u000b\f\r\u0085\u2028\u2029".indexOf(input.charAt(start - 1)) == -1) {
            return null;
        }
        final Matcher region = FindAddress.sHouseNumberRe.matcher(input).region(start, input.length());
        if (region.lookingAt()) {
    ...
    @VisibleForTesting
    public static MatchResult matchState(final String input, final int start) {
        final MatchResult matchResult = null;
        if (start > 0 && ",*\u2022\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\n\u000b\f\r\u0085\u2028\u2029".indexOf(input.charAt(start - 1)) == -1) {
            return null;
        }
        final Matcher region = FindAddress.sStateRe.matcher(input).region(start, input.length());
    ...
    private static class ZipRange
    {
        ...
        ZipRange(final int mLow, final int mHigh, final int n, final int n2) {
            this.mLow = mLow;
            this.mHigh = mHigh;
            this.mException1 = n;
            this.mException2 = n;
