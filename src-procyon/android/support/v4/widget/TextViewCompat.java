        ...
        private void recomputeProcessTextMenuItems(final Menu obj) {
            ...
            try {
                ...
                for (int j = 0; j < supportedActivities.size(); ++j) {
                    ...
                    obj.add(0, 0, 100 + j, resolveInfo.loadLabel(packageManager)).setIntent(this.createProcessTextIntentForResolveInfo(resolveInfo, this.mTextView)).setShowAsAction(1);
                }
            }
