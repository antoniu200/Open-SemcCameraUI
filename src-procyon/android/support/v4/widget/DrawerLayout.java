...
public class DrawerLayout extends ViewGroup
{
    ...
    public DrawerLayout(@NonNull Context obtainStyledAttributes, @Nullable final AttributeSet set, final int n) {
    ...
    private class ViewDragCallback extends Callback
    {
        ...
        public void onViewPositionChanged(final View view, int visibility, int width, final int n, final int n2) {
            ...
            float n3;
            if (this.this$0.checkDrawerViewAbsoluteGravity(view, 3)) {
                n3 = (visibility + width) / (float)width;
            }
            else {
                n3 = (this.this$0.getWidth() - visibility) / (float)width;
            }
