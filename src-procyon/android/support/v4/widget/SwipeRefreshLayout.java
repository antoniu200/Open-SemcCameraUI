...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild
{
    ...
    public SwipeRefreshLayout(@NonNull final Context context) {
        this(context, null);
    }
    
    public SwipeRefreshLayout(@NonNull final Context context, @Nullable final AttributeSet set) {
        super(context, set);
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            ...
            public void applyTransformation(final float n, final Transformation transformation) {
                ...
                this.this$0.setTargetOffsetTopAndBottom(this.this$0.mFrom + (int)((mSpinnerOffsetEnd - this.this$0.mFrom) * n) - this.this$0.mCircleView.getTop());
    ...
    private void moveSpinner(final float a) {
        ...
        if (this.mCustomSlingshotDistance > 0) {
            n = this.mCustomSlingshotDistance;
        }
        ...
        this.mProgress.setProgressRotation((-0.25f + 0.4f * b + n3 * 2.0f) * 0.5f);
    ...
    protected void onLayout(final boolean b, int measuredWidth, int n, int n2, int paddingTop) {
        ...
        mTarget.layout(n, paddingTop, measuredWidth - this.getPaddingLeft() - this.getPaddingRight() + n, n2 - this.getPaddingTop() - this.getPaddingBottom() + paddingTop);
    ...
    public void setOnRefreshListener(@Nullable final OnRefreshListener mListener) {
    ...
    public void setSlingshotDistance(@Px final int mCustomSlingshotDistance) {
        this.mCustomSlingshotDistance = mCustomSlingshotDistance;
    }
    ...
    {
        boolean canChildScrollUp(@NonNull final SwipeRefreshLayout p0, @Nullable final View p1);
    }
