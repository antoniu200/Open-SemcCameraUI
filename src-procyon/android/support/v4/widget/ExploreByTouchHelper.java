...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat
{
    ...
    public ExploreByTouchHelper(@NonNull final View mHost) {
    ...
    private boolean moveFocus(int key, @Nullable final Rect rect) {
        ...
        if (key != 17 && key != 33 && key != 66 && key != 130) {
            switch (key) {
                ...
                case 1:
                case 2: {
                    accessibilityNodeInfoCompat2 = FocusStrategy.findNextFocusInRelativeDirection((SparseArrayCompat)allNodes, (FocusStrategy.CollectionAdapter<SparseArrayCompat, AccessibilityNodeInfoCompat>)ExploreByTouchHelper.SPARSE_VALUES_ADAPTER, ExploreByTouchHelper.NODE_ADAPTER, accessibilityNodeInfoCompat, key, ViewCompat.getLayoutDirection(this.mHost) == 1, false);
                    break;
                }
            }
        }
    ...
    public final boolean dispatchHoverEvent(@NonNull final MotionEvent motionEvent) {
        ...
        boolean b = false;
        if (enabled && this.mManager.isTouchExplorationEnabled()) {
    ...
    protected abstract boolean onPerformActionForVirtualView(final int p0, final int p1, @Nullable final Bundle p2);
    
    protected void onPopulateEventForHost(@NonNull final AccessibilityEvent accessibilityEvent) {
    }
    
    protected void onPopulateEventForVirtualView(final int n, @NonNull final AccessibilityEvent accessibilityEvent) {
    }
    
    protected void onPopulateNodeForHost(@NonNull final AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
    }
    
    protected abstract void onPopulateNodeForVirtualView(final int p0, @NonNull final AccessibilityNodeInfoCompat p1);
    ...
    private class MyNodeProvider extends AccessibilityNodeProviderCompat
    {
        ...
        MyNodeProvider(final ExploreByTouchHelper this$0) {
            this.this$0 = this$0;
        }
        ...
        public AccessibilityNodeInfoCompat findFocus(int n) {
            if (n == 2) {
                n = this.this$0.mAccessibilityFocusedVirtualViewId;
            }
            else {
                n = this.this$0.mKeyboardFocusedVirtualViewId;
            }
