...
public class CircularProgressDrawable extends Drawable implements Animatable
{
    ...
    public CircularProgressDrawable(@NonNull final Context context) {
    ...
    private void setupAnimators() {
        ...
        ofFloat.addUpdateListener((ValueAnimator$AnimatorUpdateListener)new ValueAnimator$AnimatorUpdateListener(this, mRing) {
        ...
        ofFloat.addListener((Animator$AnimatorListener)new Animator$AnimatorListener(this, mRing) {
            final CircularProgressDrawable this$0;
            final Ring val$ring;
    ...
    void applyTransformation(final float n, final Ring ring, final boolean b) {
        if (this.mFinishing) {
            ...
            if (n < 0.5f) {
                ...
                final float n3 = startingStartTrim;
                final float n4 = 0.79f * interpolation + 0.01f + startingStartTrim;
                startTrim = n3;
                endTrim = n4;
            }
            else {
                final float n5 = (n - 0.5f) / 0.5f;
                endTrim = ring.getStartingStartTrim() + 0.79f;
                startTrim = endTrim - (0.79f * (1.0f - CircularProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(n5)) + 0.01f);
            }
            final float mRotationCount = this.mRotationCount;
            ring.setStartTrim(startTrim);
            ring.setEndTrim(endTrim);
            ring.setRotation(startingRotation + 0.20999998f * n);
            this.setRotation(216.0f * (n + mRotationCount));
        }
    }
    ...
    public void setColorSchemeColors(@NonNull final int... colors) {
    ...
    public void setStrokeCap(@NonNull final Paint$Cap strokeCap) {
