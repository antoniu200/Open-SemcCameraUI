...
public final class PathSegment
{
    ...
    public PathSegment(@NonNull final PointF pointF, final float mStartFraction, @NonNull final PointF pointF2, final float mEndFraction) {
    ...
    public int hashCode() {
        ...
        return 31 * ((hashCode * 31 + floatToIntBits2) * 31 + hashCode2) + floatToIntBits;
    }
