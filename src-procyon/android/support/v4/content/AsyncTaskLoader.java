...
public abstract class AsyncTaskLoader<D> extends Loader<D>
{
    ...
    public AsyncTaskLoader(@NonNull final Context context) {
        this(context, ModernAsyncTask.THREAD_POOL_EXECUTOR);
    }
    
    private AsyncTaskLoader(@NonNull final Context context, @NonNull final Executor mExecutor) {
        super(context);
    ...
    public void onCanceled(@Nullable final D n) {
    }
