...
public final class MediaMetadataCompat implements Parcelable
{
    ...
    MediaMetadataCompat(final Bundle bundle) {
        MediaSessionCompat.ensureClassLoader(this.mBundle = new Bundle(bundle));
    }
    ...
    public MediaDescriptionCompat getDescription() {
        ...
        while (true) {
            for (int i = 0; i < MediaMetadataCompat.PREFERRED_URI_ORDER.length; ++i) {
                final String string2 = this.getString(MediaMetadataCompat.PREFERRED_URI_ORDER[i]);
