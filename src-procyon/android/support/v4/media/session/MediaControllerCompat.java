...
public final class MediaControllerCompat
{
    ...
    public MediaControllerCompat(final Context context, @NonNull MediaSessionCompat mediaSessionCompat) {
        this.mRegisteredCallbacks = new HashSet<Callback>();
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl
    {
        ...
        public final void registerCallback(final Callback key, final Handler handler) {
            MediaControllerCompatApi21.registerCallback(this.mControllerObj, key.mCallbackObj, handler);
