...
public final class ArraySet<E> implements Collection<E>, Set<E>
{
    ...
    public ArraySet(@Nullable final ArraySet<E> set) {
        this();
        if (set != null) {
    ...
    public ArraySet(@Nullable final Collection<E> collection) {
        this();
        if (collection != null) {
    ...
    public boolean add(@Nullable final E e) {
        ...
        if (n2 < this.mSize) {
            ...
            final int n4 = n2 + 1;
            System.arraycopy(mHashes2, n2, mHashes3, n4, this.mSize - n2);
            System.arraycopy(this.mArray, n2, this.mArray, n4, this.mSize - n2);
        }
        this.mHashes[n2] = hashCode;
        this.mArray[n2] = e;
        ++this.mSize;
        return true;
    }
    
    public void addAll(@NonNull final ArraySet<? extends E> set) {
    ...
    public void append(final E e) {
        ...
        if (mSize > 0 && this.mHashes[mSize - 1] > hashCode) {
            this.add(e);
            return;
        }
        this.mSize = mSize + 1;
        this.mHashes[mSize] = hashCode;
        this.mArray[mSize] = e;
    }
    ...
    public boolean removeAll(@NonNull final ArraySet<? extends E> set) {
        final int mSize = set.mSize;
        final int mSize2 = this.mSize;
        boolean b = false;
    ...
    public E removeAt(final int n) {
        ...
        if (this.mSize <= 1) {
            ...
            if (length > 8 && this.mSize < this.mHashes.length / 3) {
                ...
                if (n < this.mSize) {
                    final int n3 = n + 1;
                    System.arraycopy(mHashes, n3, this.mHashes, n, this.mSize - n);
                ...
                if (n < this.mSize) {
                    final int[] mHashes2 = this.mHashes;
                    final int n4 = n + 1;
                    System.arraycopy(mHashes2, n4, this.mHashes, n, this.mSize - n);
