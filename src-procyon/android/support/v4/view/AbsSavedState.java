...
public abstract class AbsSavedState implements Parcelable
{
    ...
    protected AbsSavedState(@NonNull final Parcel parcel) {
        this(parcel, null);
    }
    
    protected AbsSavedState(@NonNull final Parcel parcel, @Nullable final ClassLoader classLoader) {
    ...
    protected AbsSavedState(@NonNull Parcelable mSuperState) {
        if (mSuperState == null) {
