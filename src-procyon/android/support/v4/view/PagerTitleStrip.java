...
public class PagerTitleStrip extends ViewGroup
{
    ...
    public PagerTitleStrip(@NonNull final Context context) {
        this(context, null);
    }
    
    public PagerTitleStrip(@NonNull final Context context, @Nullable final AttributeSet set) {
        super(context, set);
    ...
    void updateTextPositions(int n, final float mLastKnownPositionOffset, final boolean b) {
        ...
        final int n3 = paddingRight + n2;
        float n5;
        final float n4 = n5 = 0.5f + mLastKnownPositionOffset;
        if (n4 > 1.0f) {
            n5 = n4 - 1.0f;
        }
        final int n6 = width - n3 - (int)((width - (paddingLeft + n2) - n3) * n5) - n2;
        final int n7 = measuredWidth2 + n6;
        ...
        final int n8 = max - baseline;
        final int n9 = max - baseline2;
        final int n10 = max - baseline3;
        final int max2 = Math.max(Math.max(this.mPrevText.getMeasuredHeight() + n8, this.mCurrText.getMeasuredHeight() + n9), this.mNextText.getMeasuredHeight() + n10);
        final int n11 = this.mGravity & 0x70;
        int n12;
        int n13;
        if (n11 != 16) {
            if (n11 != 80) {
                ...
                final int n14 = n - paddingBottom - max2;
                n = n8 + n14;
                n12 = n9 + n14;
                n13 = n14 + n10;
            }
            ...
            final int n15 = (n - paddingTop - paddingBottom - max2) / 2;
            n = n8 + n15;
            n12 = n9 + n15;
            n13 = n15 + n10;
        }
        this.mCurrText.layout(n6, n12, n7, this.mCurrText.getMeasuredHeight() + n12);
        final int min = Math.min(paddingLeft, n6 - this.mScaledTextSpacing - measuredWidth);
        this.mPrevText.layout(min, n, measuredWidth + min, this.mPrevText.getMeasuredHeight() + n);
        n = Math.max(width - paddingRight - measuredWidth3, n7 + this.mScaledTextSpacing);
        this.mNextText.layout(n, n13, n + measuredWidth3, this.mNextText.getMeasuredHeight() + n13);
    ...
    private class PageListener extends DataSetObserver implements OnPageChangeListener, OnAdapterChangeListener
    {
        ...
        PageListener(final PagerTitleStrip this$0) {
            this.this$0 = this$0;
        }
        ...
        public void onChanged() {
            ...
            this.this$0.updateTextPositions(this.this$0.mPager.getCurrentItem(), mLastKnownPositionOffset2, true);
        }
