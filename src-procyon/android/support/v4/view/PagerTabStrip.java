...
public class PagerTabStrip extends PagerTitleStrip
{
    ...
    public PagerTabStrip(@NonNull final Context context) {
        this(context, null);
    }
    
    public PagerTabStrip(@NonNull final Context context, @Nullable final AttributeSet set) {
        super(context, set);
        ...
        this.mPrevText.setOnClickListener((View$OnClickListener)new View$OnClickListener(this) {
        ...
        this.mNextText.setOnClickListener((View$OnClickListener)new View$OnClickListener(this) {
            final PagerTabStrip this$0;
