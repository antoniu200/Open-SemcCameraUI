...
public class NotificationCompat
{
    ...
    static Action getActionCompatFromAction(final Notification$Action notification$Action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i = 0; i < remoteInputs.length; ++i) {
                ...
                array[i] = new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), remoteInput.getExtras(), null);
            }
        }
        boolean boolean1;
        ...
        return new Action(notification$Action.icon, notification$Action.title, notification$Action.actionIntent, notification$Action.getExtras(), array, null, boolean1, n, boolean2);
    }
    ...
    public abstract static class Style
    {
        ...
        private Bitmap createColoredBitmap(int intrinsicWidth, final int n, final int n2) {
        ...
        public RemoteViews applyStandardTemplate(final boolean b, int n, final boolean b2) {
            ...
            final Bitmap mLargeIcon = this.mBuilder.mLargeIcon;
            final int n2 = 8;
            if (mLargeIcon != null) {
                if (Build$VERSION.SDK_INT >= 16) {
    ...
    public static class Builder
    {
        ...
        public Builder setLights(@ColorInt int ledARGB, final int ledOnMS, final int ledOffMS) {
            ...
            this.mNotification.flags = (ledARGB | (this.mNotification.flags & 0xFFFFFFFE));
            return this;
        }
    ...
    public static class DecoratedCustomViewStyle extends Style
    {
        ...
        private RemoteViews createRemoteViews(final RemoteViews remoteViews, final boolean b) {
                ...
                if (b && this.mBuilder.mActions != null) {
                    ...
                    if (min > 0) {
                        ...
                        while (true) {
                            ...
                            applyStandardTemplate.addView(R.id.actions, this.generateActionButton(this.mBuilder.mActions.get(index)));
                            ++index;
                        }
                    }
                }
            ...
            applyStandardTemplate.setViewVisibility(R.id.actions, n4);
            applyStandardTemplate.setViewVisibility(R.id.action_divider, n4);
    ...
    public static class MessagingStyle extends Style
    {
        ...
        public void addCompatExtras(final Bundle bundle) {
            ...
            if (this.mIsGroupConversation != null) {
                bundle.putBoolean("android.isGroupConversation", (boolean)this.mIsGroupConversation);
            }
        }
        ...
        public boolean isGroupConversation() {
            ...
            if (this.mIsGroupConversation != null) {
                booleanValue = this.mIsGroupConversation;
            }
            return booleanValue;
        }
        ...
        public static final class Message
        {
            ...
            public Message(final CharSequence mText, final long mTimestamp, @Nullable final Person mPerson) {
                this.mExtras = new Bundle();
                this.mText = mText;
