...
public final class NotificationManagerCompat
{
    ...
    public static Set<String> getEnabledListenerPackages(@NonNull Context sEnabledNotificationListenersLock) {
        ...
        Label_0113: {
            ...
            try {
                ...
                final Set<String> sEnabledNotificationListenerPackages2 = NotificationManagerCompat.sEnabledNotificationListenerPackages;
                monitorexit(sEnabledNotificationListenersLock);
                return sEnabledNotificationListenerPackages2;
            }
        }
    }
    ...
    public boolean areNotificationsEnabled() {
        ...
        if (sdk_INT >= 19) {
            ...
            try {
                ...
                if ((int)forName.getMethod("checkOpNoThrow", Integer.TYPE, Integer.TYPE, String.class).invoke(obj, (int)forName.getDeclaredField("OP_POST_NOTIFICATION").get(Integer.class), uid, packageName) != 0) {
                    b = false;
                }
                return b;
            }
    ...
    private static class SideChannelManager implements Handler$Callback, ServiceConnection
    {
        ...
        private void scheduleListenerRetry(final ListenerRecord listenerRecord) {
            ...
            final int i = 1000 * (1 << listenerRecord.retryCount - 1);
            if (Log.isLoggable("NotifManCompat", 3)) {
                final StringBuilder sb2 = new StringBuilder();
