...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, OpGenerator
{
    ...
    private void doAddOp(final int mContainerId, final Fragment obj, @Nullable final String str, final int n) {
    ...
    @Override
    public FragmentTransaction add(final int n, final Fragment fragment, @Nullable final String s) {
        this.doAddOp(n, fragment, s, 1);
        return this;
    }
    
    @Override
    public FragmentTransaction add(final Fragment fragment, @Nullable final String s) {
    ...
    @Override
    public FragmentTransaction addToBackStack(@Nullable final String mName) {
    ...
    @Override
    public FragmentTransaction replace(final int n, final Fragment fragment, @Nullable final String s) {
        if (n == 0) {
    ...
    @Override
    public FragmentTransaction setBreadCrumbShortTitle(@Nullable final CharSequence mBreadCrumbShortTitleText) {
    ...
    @Override
    public FragmentTransaction setBreadCrumbTitle(@Nullable final CharSequence mBreadCrumbTitleText) {
    ...
    @Override
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable final Fragment fragment) {
