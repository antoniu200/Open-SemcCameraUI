...
public final class AsyncDifferConfig<T>
{
    ...
    AsyncDifferConfig(@NonNull final Executor mMainThreadExecutor, @NonNull final Executor mBackgroundThreadExecutor, @NonNull final DiffUtil.ItemCallback<T> mDiffCallback) {
