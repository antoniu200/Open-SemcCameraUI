...
public class AlertDialog extends AppCompatDialog implements DialogInterface
{
    ...
    public void setButton(final int n, final CharSequence charSequence, final DialogInterface$OnClickListener dialogInterface$OnClickListener) {
        this.mAlert.setButton(n, charSequence, dialogInterface$OnClickListener, null, null);
    }
    
    public void setButton(final int n, final CharSequence charSequence, final Drawable drawable, final DialogInterface$OnClickListener dialogInterface$OnClickListener) {
        this.mAlert.setButton(n, charSequence, dialogInterface$OnClickListener, null, drawable);
    }
    ...
    public static class Builder
    {
        ...
        public Builder setNegativeButtonIcon(final Drawable mNegativeButtonIcon) {
            this.P.mNegativeButtonIcon = mNegativeButtonIcon;
            return this;
        }
        ...
        public Builder setNeutralButtonIcon(final Drawable mNeutralButtonIcon) {
            this.P.mNeutralButtonIcon = mNeutralButtonIcon;
            return this;
        }
        ...
        public Builder setPositiveButtonIcon(final Drawable mPositiveButtonIcon) {
            this.P.mPositiveButtonIcon = mPositiveButtonIcon;
            return this;
        }
