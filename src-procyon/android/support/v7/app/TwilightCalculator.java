...
class TwilightCalculator
{
    ...
    public void calculateTwilight(final long n, double a, double n2) {
        ...
        final double n5 = n4;
        final double a2 = 0.03341960161924362 * Math.sin(n5) + n5 + 3.4906598739326E-4 * Math.sin(2.0f * n4) + 5.236000106378924E-6 * Math.sin(3.0f * n4) + 1.796593063 + 3.141592653589793;
        n2 = -n2 / 360.0;
        n2 = Math.round(n3 - 9.0E-4f - n2) + 9.0E-4f + n2 + 0.0053 * Math.sin(n5) + -0.0069 * Math.sin(2.0 * a2);
