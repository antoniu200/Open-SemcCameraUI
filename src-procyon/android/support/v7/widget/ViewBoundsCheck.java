...
class ViewBoundsCheck
{
    ...
    static class BoundFlags
    {
        ...
        boolean boundsMatch() {
            return ((this.mBoundFlags & 0x7) == 0x0 || (this.mBoundFlags & this.compare(this.mChildStart, this.mRvStart) << 0) != 0x0) && ((this.mBoundFlags & 0x70) == 0x0 || (this.mBoundFlags & this.compare(this.mChildStart, this.mRvEnd) << 4) != 0x0) && ((this.mBoundFlags & 0x700) == 0x0 || (this.mBoundFlags & this.compare(this.mChildEnd, this.mRvStart) << 8) != 0x0) && ((this.mBoundFlags & 0x7000) == 0x0 || (this.compare(this.mChildEnd, this.mRvEnd) << 12 & this.mBoundFlags) != 0x0);
        }
