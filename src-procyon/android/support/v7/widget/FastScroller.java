...
class FastScroller extends ItemDecoration implements OnItemTouchListener
{
    ...
    void updateScrollPosition(final int n, final int n2) {
        ...
        if (this.mNeedVerticalScrollbar) {
            ...
            final float n4 = (float)mRecyclerViewHeight;
            this.mVerticalThumbCenterY = (int)(n4 * (n3 + n4 / 2.0f) / computeVerticalScrollRange);
        ...
        if (this.mNeedHorizontalScrollbar) {
            ...
            final float n6 = (float)mRecyclerViewWidth;
            this.mHorizontalThumbCenterX = (int)(n6 * (n5 + n6 / 2.0f) / computeHorizontalScrollRange);
    ...
    private class AnimatorListener extends AnimatorListenerAdapter
    {
        ...
        AnimatorListener(final FastScroller this$0) {
            this.this$0 = this$0;
    ...
    private class AnimatorUpdater implements ValueAnimator$AnimatorUpdateListener
    {
        ...
        AnimatorUpdater(final FastScroller this$0) {
            this.this$0 = this$0;
        }
        
        public void onAnimationUpdate(final ValueAnimator valueAnimator) {
            final int n = (int)(255.0f * (float)valueAnimator.getAnimatedValue());
