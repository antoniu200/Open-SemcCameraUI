...
public class SupportMenuInflater extends MenuInflater
{
    ...
    public void inflate(@LayoutRes final int n, final Menu menu) {
        ...
        try {
            try {
                ...
                catch (final IOException xmlResourceParser) {}
                catch (final XmlPullParserException xmlResourceParser) {}
                finally {
        ...
        catch (final IOException layout) {}
        catch (final XmlPullParserException layout) {}
        throw new InflateException("Error inflating menu XML", (Throwable)layout);
    ...
    private class MenuState
    {
        ...
        private <T> T newInstance(final String s, final Class<?>[] parameterTypes, final Object[] initargs) {
            try {
                final Constructor<?> constructor = this.this$0.mContext.getClassLoader().loadClass(s).getConstructor(parameterTypes);
        ...
        private void setItem(final MenuItem menuItem) {
            ...
            if (this.itemActionViewClassName != null) {
                menuItem.setActionView((View)this.newInstance(this.itemActionViewClassName, SupportMenuInflater.ACTION_VIEW_CONSTRUCTOR_SIGNATURE, this.this$0.mActionViewConstructorArguments));
                b = true;
            }
