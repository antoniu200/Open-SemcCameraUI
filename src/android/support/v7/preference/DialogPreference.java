...
public abstract class DialogPreference extends Preference {
    ...
    public DialogPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mDialogTitle = TypedArrayUtils.getString(typedArrayObtainStyledAttributes, R.styleable.DialogPreference_dialogTitle, R.styleable.DialogPreference_android_dialogTitle);
