...
public final class TiffTagConstants {
    ...
    public static final TagInfoLong TIFF_TAG_NEW_SUBFILE_TYPE = new TagInfoLong("NewSubfileType", 254, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_SUBFILE_TYPE = new TagInfoShort("SubfileType", 255, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    ...
    public static final TagInfoShort TIFF_TAG_BITS_PER_SAMPLE = new TagInfoShort("BitsPerSample", 258, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_COMPRESSION = new TagInfoShort("Compression", 259, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_PHOTOMETRIC_INTERPRETATION = new TagInfoShort("PhotometricInterpretation", 262, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_THRESHHOLDING = new TagInfoShort("Threshholding", 263, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_CELL_WIDTH = new TagInfoShort("CellWidth", 264, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_CELL_LENGTH = new TagInfoShort("CellLength", 265, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_FILL_ORDER = new TagInfoShort("FillOrder", 266, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    ...
    public static final TagInfoShort TIFF_TAG_ORIENTATION = new TagInfoShort("Orientation", 274, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_SAMPLES_PER_PIXEL = new TagInfoShort("SamplesPerPixel", 277, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    ...
    public static final TagInfoShort TIFF_TAG_MIN_SAMPLE_VALUE = new TagInfoShort("MinSampleValue", 280, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_MAX_SAMPLE_VALUE = new TagInfoShort("MaxSampleValue", 281, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoRational TIFF_TAG_XRESOLUTION = new TagInfoRational("XResolution", 282, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoRational TIFF_TAG_YRESOLUTION = new TagInfoRational("YResolution", 283, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_PLANAR_CONFIGURATION = new TagInfoShort("PlanarConfiguration", 284, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    ...
    public static final TagInfoRational TIFF_TAG_XPOSITION = new TagInfoRational("XPosition", 286, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoRational TIFF_TAG_YPOSITION = new TagInfoRational("YPosition", 287, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoLong TIFF_TAG_FREE_OFFSETS = new TagInfoLong("FreeOffsets", 288, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoLong TIFF_TAG_FREE_BYTE_COUNTS = new TagInfoLong("FreeByteCounts", 289, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_GRAY_RESPONSE_UNIT = new TagInfoShort("GrayResponseUnit", 290, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_GRAY_RESPONSE_CURVE = new TagInfoShort("GrayResponseCurve", 291, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoLong TIFF_TAG_T4_OPTIONS = new TagInfoLong("T4Options", 292, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoLong TIFF_TAG_T6_OPTIONS = new TagInfoLong("T6Options", 293, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_RESOLUTION_UNIT = new TagInfoShort("ResolutionUnit", 296, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_PAGE_NUMBER = new TagInfoShort("PageNumber", 297, 2, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_TRANSFER_FUNCTION = new TagInfoShort("TransferFunction", 301, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    ...
    public static final TagInfoShort TIFF_TAG_PREDICTOR = new TagInfoShort("Predictor", 317, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoRational TIFF_TAG_WHITE_POINT = new TagInfoRational("WhitePoint", 318, 2, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoRational TIFF_TAG_PRIMARY_CHROMATICITIES = new TagInfoRational("PrimaryChromaticities", 319, 6, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_COLOR_MAP = new TagInfoShort("ColorMap", 320, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_HALFTONE_HINTS = new TagInfoShort("HalftoneHints", 321, 2, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    ...
    public static final TagInfoLong TIFF_TAG_TILE_OFFSETS = new TagInfoLong("TileOffsets", 324, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT, true);
    ...
    public static final TagInfoShort TIFF_TAG_INK_SET = new TagInfoShort("InkSet", 332, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    ...
    public static final TagInfoShort TIFF_TAG_NUMBER_OF_INKS = new TagInfoShort("NumberOfInks", 334, 1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    ...
    public static final TagInfoShort TIFF_TAG_EXTRA_SAMPLES = new TagInfoShort("ExtraSamples", 338, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_SAMPLE_FORMAT = new TagInfoShort("SampleFormat", 339, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    ...
    public static final TagInfoShort TIFF_TAG_JPEG_POINT_TRANSFORMS = new TagInfoShort("JPEGPointTransforms", 518, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoLong TIFF_TAG_JPEG_QTABLES = new TagInfoLong("JPEGQTables", 519, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoLong TIFF_TAG_JPEG_DCTABLES = new TagInfoLong("JPEGDCTables", 520, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoLong TIFF_TAG_JPEG_ACTABLES = new TagInfoLong("JPEGACTables", 521, -1, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoRational TIFF_TAG_YCBCR_COEFFICIENTS = new TagInfoRational("YCbCrCoefficients", 529, 3, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
    public static final TagInfoShort TIFF_TAG_YCBCR_SUB_SAMPLING = new TagInfoShort("YCbCrSubSampling", 530, 2, TiffDirectoryType.TIFF_DIRECTORY_ROOT);
