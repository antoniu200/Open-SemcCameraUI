...
public class SuperiorParameters extends MainParameters {
    ...
    public SuperiorParameters(Context context, CapturingMode capturingMode, boolean z, ModeIndependentParams modeIndependentParams) {
    ...
    protected void updateSelectability() {
        ...
        boolean zIsSteadyShotSupported = VideoStabilizer.isSteadyShotSupported(this.mCapturingModeParams.getActionMode().mCameraId, (VideoSize) this.mCapturingModeParams.mVideoSize.get());
        boolean zIsIntelligentActiveAvailable = DependencyCheckUtil.isIntelligentActiveAvailable(this.mCapturingModeParams.getActionMode().mCameraId, (VideoSize) this.mCapturingModeParams.mVideoSize.get(), (VideoHdr) this.mCapturingModeParams.mVideoHdr.get());
