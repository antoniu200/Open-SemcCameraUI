...
class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    @NotNull
    public static final byte[] readBytes(@NotNull File receiver) throws IOException {
        ...
        try {
            ...
            while (i2 > 0) {
                int i3 = fileInputStream2.read(bArrCopyOf, i, i2);
                if (i3 < 0) {
                    break;
                }
                i2 -= i3;
    ...
    public static final void writeBytes(@NotNull File receiver, @NotNull byte[] array) throws IOException {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
    ...
    public static final void appendBytes(@NotNull File receiver, @NotNull byte[] array) throws IOException {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(array, "array");
    ...
    public static final void forEachBlock(@NotNull File receiver, int i, @NotNull Function2<? super byte[], ? super Integer, Unit> action) throws IOException {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(action, "action");
    ...
    public static final void forEachLine(@NotNull File receiver, @NotNull Charset charset, @NotNull Function1<? super String, Unit> action) throws IOException {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(charset, "charset");
        Intrinsics.checkParameterIsNotNull(action, "action");
    ...
    public static /* bridge */ /* synthetic */ Object useLines$default(File receiver, Charset charset, Function1 block, int i, Object obj) throws IOException {
        if ((i & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
    ...
    public static final <T> T useLines(@NotNull File receiver, @NotNull Charset charset, @NotNull Function1<? super Sequence<String>, ? extends T> block) throws IOException {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(charset, "charset");
        Intrinsics.checkParameterIsNotNull(block, "block");
        Reader inputStreamReader = new InputStreamReader(new FileInputStream(receiver), charset);
