...
public final class ByteStreamsKt {
    ...
    public static final long copyTo(@NotNull InputStream receiver, @NotNull OutputStream out, int i) throws IOException {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(out, "out");
        byte[] bArr = new byte[i];
        int i2 = receiver.read(bArr);
        long j = 0;
        while (i2 >= 0) {
            out.write(bArr, 0, i2);
            j += i2;
            i2 = receiver.read(bArr);
        }
        return j;
    }
    ...
    @NotNull
    public static final byte[] readBytes(@NotNull InputStream receiver, int i) {
        Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
