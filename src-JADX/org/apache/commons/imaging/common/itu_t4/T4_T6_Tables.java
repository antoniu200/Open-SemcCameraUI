...
class T4_T6_Tables {
    ...
    public static final Entry[] WHITE_MAKE_UP_CODES = {new Entry("11011", 64), new Entry("10010", 128), new Entry("010111", 192), new Entry("0110111", 256), new Entry("00110110", 320), new Entry("00110111", 384), new Entry("01100100", 448), new Entry("01100101", 512), new Entry("01101000", 576), new Entry("01100111", 640), new Entry("011001100", 704), new Entry("011001101", 768), new Entry("011010010", 832), new Entry("011010011", 896), new Entry("011010100", 960), new Entry("011010101", 1024), new Entry("011010110", 1088), new Entry("011010111", 1152), new Entry("011011000", 1216), new Entry("011011001", SizeConstants.WIDTH_PREVIEW_HD), new Entry("011011010", 1344), new Entry("011011011", 1408), new Entry("010011000", 1472), new Entry("010011001", 1536), new Entry("010011010", Constants.WAITING_TIME_STOP_REC), new Entry("011000", 1664), new Entry("010011011", 1728)};
    public static final Entry[] BLACK_MAKE_UP_CODES = {new Entry("0000001111", 64), new Entry("000011001000", 128), new Entry("000011001001", 192), new Entry("000001011011", 256), new Entry("000000110011", 320), new Entry("000000110100", 384), new Entry("000000110101", 448), new Entry("0000001101100", 512), new Entry("0000001101101", 576), new Entry("0000001001010", 640), new Entry("0000001001011", 704), new Entry("0000001001100", 768), new Entry("0000001001101", 832), new Entry("0000001110010", 896), new Entry("0000001110011", 960), new Entry("0000001110100", 1024), new Entry("0000001110101", 1088), new Entry("0000001110110", 1152), new Entry("0000001110111", 1216), new Entry("0000001010010", SizeConstants.WIDTH_PREVIEW_HD), new Entry("0000001010011", 1344), new Entry("0000001010100", 1408), new Entry("0000001010101", 1472), new Entry("0000001011010", 1536), new Entry("0000001011011", Constants.WAITING_TIME_STOP_REC), new Entry("0000001100100", 1664), new Entry("0000001100101", 1728)};
    public static final Entry[] ADDITIONAL_MAKE_UP_CODES = {new Entry("00000001000", 1792), new Entry("00000001100", 1856), new Entry("00000001101", SizeConstants.WIDTH_PREVIEW_FULL_HD), new Entry("000000010010", 1984), new Entry("000000010011", 2048), new Entry("000000010100", 2112), new Entry("000000010101", 2176), new Entry("000000010110", 2240), new Entry("000000010111", 2304), new Entry("000000011100", 2368), new Entry("000000011101", 2432), new Entry("000000011110", 2496), new Entry("000000011111", 2560)};
