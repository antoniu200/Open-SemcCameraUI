...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public void setStatusBarBackground(@Nullable Drawable drawable) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public void setStatusBarBackgroundResource(@DrawableRes int i) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        setStatusBarBackground(i != 0 ? ContextCompat.getDrawable(getContext(), i) : null);
    }

    public void setStatusBarBackgroundColor(@ColorInt int i) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    */
    ...
    private void setupForInsets() {
        ...
        if (ViewCompat.getFitsSystemWindows(this)) {
            ...
            setSystemUiVisibility(SizeConstants.WIDTH_PREVIEW_HD);
            return;
        }
