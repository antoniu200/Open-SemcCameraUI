...
public class FontsContractCompat {
    ...
    public static Typeface getFontSync(final Context context, final FontRequest fontRequest, @Nullable final ResourcesCompat.FontCallback fontCallback, @Nullable final Handler handler, boolean z, int i, final int i2) {
        final String str = fontRequest.getIdentifier() + UserSettingValueHolder.DELIMITER + i2;
        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    arrayList2.add(new FontInfo(uriWithAppendedId, i2, columnIndex5 != -1 ? cursor.getInt(columnIndex5) : SomcMediaStore.AUTHORITY_NEW_VERSION, columnIndex6 != -1 && cursor.getInt(columnIndex6) == 1, i));
                }
