...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    public AutoScrollHelper(@NonNull View view) {
        ...
        setRampUpDuration(Constants.INTERVAL_OPEN_CAMERA);
        setRampDownDuration(Constants.INTERVAL_OPEN_CAMERA);
    }
    ...
    private static class ClampedScroller {
        ...
        private float getValueAt(long j) {
            ...
            if (this.mStopTime < 0 || j < this.mStopTime) {
                return 0.5f * AutoScrollHelper.constrain((j - this.mStartTime) / this.mRampUpDuration, 0.0f, AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY);
            }
