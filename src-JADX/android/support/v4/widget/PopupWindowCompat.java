...
public final class PopupWindowCompat {
    ...
    public static void setWindowLayoutType(@NonNull PopupWindow popupWindow, int i) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (Build.VERSION.SDK_INT >= 23) {
