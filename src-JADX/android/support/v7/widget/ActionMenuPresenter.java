...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (z3 || i6 + i5 > i7)) {
            i7--;
        }
        int i9 = i7 - i5;
        ...
        if (actionMenuPresenter.mStrictWidthLimit) {
            iMeasureChildForCells = i4 / actionMenuPresenter.mMinCellSize;
            i = ((i4 % actionMenuPresenter.mMinCellSize) / iMeasureChildForCells) + actionMenuPresenter.mMinCellSize;
        } else {
        ...
        while (i12 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                boolean z5 = (i9 > 0 || z4) && i11 > 0 && (!actionMenuPresenter.mStrictWidthLimit || iMeasureChildForCells > 0);
                if (z5) {
                    boolean z6 = z5;
                    ...
                    z5 = actionMenuPresenter.mStrictWidthLimit ? z6 & (i11 >= 0) : z6 & (i11 + i10 > 0);
                } else {
                    i2 = size;
                }
                if (z5 && groupId2 != 0) {
