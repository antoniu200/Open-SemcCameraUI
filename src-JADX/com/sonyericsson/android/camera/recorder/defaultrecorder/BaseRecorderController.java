...
public class BaseRecorderController implements RecorderController {
    ...
    protected void playStartSound() throws ExecutionException, InterruptedException {
    ...
    protected boolean pauseInternal() throws InterruptedException {
    ...
    public boolean release() {
        ...
        synchronized (this.mStateLock) {
            ...
            if (zVerifyState) {
                executeInBackground(new Runnable() { // from class: com.sonyericsson.android.camera.recorder.defaultrecorder.BaseRecorderController.1
                    @Override // java.lang.Runnable
                    public void run() {
                        synchronized (BaseRecorderController.this.mStateLock) {
                            if (BaseRecorderController.this.verifyState(State.RELEASED)) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void playStopSound() throws ExecutionException, InterruptedException {
    ...
    protected void waitUntilFirstVideoFrameWritten() throws InterruptedException {
