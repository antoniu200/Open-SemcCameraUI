...
public class OkCancelWithCheckBoxDialogBuilder extends MessageDialogBuilder {
    ...
    protected RotatableDialog create(Context context, int i, MessageSettings messageSettings, MessageDialogRequest messageDialogRequest, final DialogInterface.OnClickListener onClickListener, final DialogInterface.OnClickListener onClickListener2, DialogInterface.OnCancelListener onCancelListener, DialogInterface.OnDismissListener onDismissListener) {
        ...
        builder.setPositiveButton(messageDialogRequest.mDialogId.positiveButtonResourceID, new DialogInterface.OnClickListener() { // from class: com.sonyericsson.android.camera.view.messagedialog.OkCancelWithCheckBoxDialogBuilder.1
        ...
        builder.setNegativeButton(messageDialogRequest.mDialogId.negativeButtonResourceID, new DialogInterface.OnClickListener() { // from class: com.sonyericsson.android.camera.view.messagedialog.OkCancelWithCheckBoxDialogBuilder.2
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i2) {
                activity.runOnUiThread(messageDialogCheckBoxListener);
